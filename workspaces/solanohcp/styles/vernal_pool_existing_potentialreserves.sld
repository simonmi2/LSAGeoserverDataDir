      ...
      <FeatureTypeStyle>
        ...
        <Rule>
          ...
          <ogc:Filter>
               ...
               <ogc:PropertyIsEqualTo>
                    ...
                    <ogc:Literal>Contra Costa Goldfield Potential Reserve Areas</ogc:Literal>
                  </ogc:PropertyIsEqualTo>
        ...
        <Rule>
          ...
          <ogc:Filter>
               <ogc:PropertyIsEqualTo>
                    <ogc:PropertyName>type</ogc:PropertyName>
                    <ogc:Literal>Potential Specialty Reserve Areas</ogc:Literal>
                  </ogc:PropertyIsEqualTo>
         ...
         <Rule>
          ...
          <ogc:Filter>
             <ogc:PropertyIsEqualTo>
                    <ogc:PropertyName>type</ogc:PropertyName>
                    <ogc:Literal>Conservation Areas with High Preservation Potential</ogc:Literal>
                  </ogc:PropertyIsEqualTo>
     </ogc:Filter>
          <PolygonSymbolizer>
                <Fill>
          ...
          <ogc:Filter>
             <ogc:PropertyIsEqualTo>
                    <ogc:PropertyName>type</ogc:PropertyName>
                    <ogc:Literal>Conservation Areas with High Preservation and Restoration Potential</ogc:Literal>
                  </ogc:PropertyIsEqualTo>
     </ogc:Filter>
          <PolygonSymbolizer>
                <Fill>
